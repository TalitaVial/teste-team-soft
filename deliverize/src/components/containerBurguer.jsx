...
import ContainerChekBox from './containerChekBox';
        ...
        <div className='container'>
            <div className='container__webBurger'>
                <div className='container__Burger'>
                    <img className='container--imgBurger' src={Burguer} alt="FotoBurger" />
                </div>
                <div className='container__description'>
                    ...
                    <div className='container__ingredients'>
                        ...
                        ebola crispy, bacon, queijo cheddar, molho cheddar e pão mix de gergelim,
            ...
            <div className='container__menu--itens'>
                <ContainerToAdd titulo="Adicionar Ingredientes" descricao="Até 8 ingredientes."/>
                <ListMenu/>
                <ContainerToAdd titulo="Precisa de Talher?"/>
                <ContainerChekBox/>
                <ButtonToAdd/>              
            </div>
            </div>  
